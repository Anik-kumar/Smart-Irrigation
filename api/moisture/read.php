...
require_once($filepath."/../db_connectLocal.php");
// echo $filepath;
...
if(empty($row2)){
  echo "<strong style='color: red' >No Data found for Morris Graph. </strong><br>";
  echo "<strong style='color: red' > Check Internet Connection. </strong>";
}else{
