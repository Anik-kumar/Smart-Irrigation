...
header("Access-Control-Allow-Origin: *");
    require_once "api/db_connectLocal.php";
    $db = new DB_CONNECT();
    ...
    <div class="center">
        ...
        <div class="center3">
            ...
            <div class="toLeft2">
                ...
                <div class="isManual">
                    <div>
                        <button type="button" id="D3-on" class="btn btn-default isManual" ><b>MOTOR ON</b></button>
                    </div> <br>
                    <div>
                        <button type="button" id="D3-of" class="btn btn-default isManual" ><b>MOTOR OFF</b></button>
                    </div>
                </div>
...
$(document).ready(function(){
    ...
    $("#auto_mode").click(function(){
        ...
        $("#D3-on").attr("disabled", true);
        $("#D3-of").attr("disabled", true);
        $("#D3-on").css({"background-color": "#E6E6E6"});
        $("#D3-of").css({"background-color": "#E6E6E6"});
        $("#mtr_mode").html("Auto Mode");
        $("#turnAuto").html("");
        $("#min_val").attr("disabled", false);
        $("#max_val").attr("disabled", false);
